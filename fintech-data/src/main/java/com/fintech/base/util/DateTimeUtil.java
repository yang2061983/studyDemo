...
public class DateTimeUtil {
    ...
    private static final String DATE_FORMAT_DOTALL = "yyyy.MM.dd";
    ...
    public static final String TIME_FORMAT_SHORT_SSSSS = "yyyyMMddHHmmssSSS";
    ...
    public static String getDateDotAllString(Date date) {
        DateFormat fmt = new SimpleDateFormat(DATE_FORMAT_DOTALL);
        return fmt.format(date);
    }
    /**
     * 得到日期字符串,格式为 yyyy年MM月dd日
    ...
    public static void main(String[] args) throws ParseException, InterruptedException {
        ...
        /*
        System.out.println(getStrDateBeforeday(new Date(), 1));
        System.out.println(getNowTimeNormalString());
        */
        //System.out.println(getPreviousMonthOfDay(new Date(), 2));

        SimpleDateFormat formatter = new SimpleDateFormat(DATE_FORMAT_CHINA);
        // formatter.parse("2015-01-01");
        //System.out.println(formatter.format(java.sql.Date.valueOf("2015-02-01")));

        //System.out.println(convertAsDateString("2015-05-06"));
        //System.out.println(longToDate("1450850845000"));
        // System.out.println(longToDate("1444969825000"));
        // System.out.println(longToDate("1442383339000"));
        // System.out.println(longToDate("1439785332000"));
        // System.out.println(longToDate("1437107489000"));
        // System.out.println(longToDate("1434439373000"));
        System.out.println(longToDate("1487260800000"));
        System.out.println(getNowTimeNormalStringSSS());
        System.out.println(getNowDateNormalString());
        DateFormat fmt = new SimpleDateFormat("d");
        System.out.println(fmt.format(new Date()));

        System.out.println(calInterval(convertAsDateString("2017-05-02"),getCurrentTime(),"D"));

        System.out.println(getDayDateNormalString(new Date()));
        ...
        System.out.println(getTwoDateMinute(a1,b1));
        ...
        System.out.println(DateTimeUtil.getNowTimeNormalStringSSS());

        System.out.println(convertAsDateString("2017-03-02"));

        System.out.println(DateTimeUtil.calInterval(new Date(),new Date(),"D"));

        System.out.println(getDateNormalString(addDate(new Date(),-1)));
        ...
        System.out.println(getWeekofYear(convertAsDateString("2018-12-31")));


        System.out.println(betweenTime("16:22:05","16:03:05","16:30:05"));
     ...
     *
     * @param date 要转换的日期时间 Date型
     * @param format 使用的日期时间格式
